...
const ForgotPassword = () => {
  return (
    <>
    <h1 className='text-gray-600 text-3xl font-bold tracking-wide text-center'>Desde aquí puedes recuperar tu contraseña y acceder a la {''} 
    <span className='text-slate-700'>librería</span></h1>
